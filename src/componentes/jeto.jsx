...
const Jeto = ({ toggleJeto }) => {
    ...
    const [displayJeto, setDisplayJeto] = useState('containerBib1')
    ...
    useEffect(() => {
        if (toggleJeto) {
            setDisplayJeto('closedJeto')
        }
    }, [toggleJeto])

    console.log('DisplayJeto: ' + displayJeto)
    console.log('ToggleJeto desde Jeto: ' + toggleJeto)
    ...
    useEffect(() => {
        if (src === './AJ_3.mp4' && playerState.progress === 100) {
            setDisplayJeto('closedJeto')
        }
    }, [src, playerState])
    ...
    return (
        <div className={displayJeto}>
            ...
            <div className='contJetoTexto'>
                <h1 className="jetoTexto" >Molesta a
